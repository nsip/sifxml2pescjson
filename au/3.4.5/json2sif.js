...
attrpaths["SystemRole"] = ["SystemRole.RefId","SystemRole.SystemContextList.SystemContext.SystemId","SystemRole.SystemContextList.SystemContext.RoleList.Role.RoleId"];
...
attrpaths["AGAddressCollectionSubmission"] = ["AGAddressCollectionSubmission.RefId","AGAddressCollectionSubmission.SubmissionContact.Name.Type","AGAddressCollectionSubmission.SubmissionContact.Address.Type","AGAddressCollectionSubmission.SubmissionContact.Address.Role","AGAddressCollectionSubmission.SubmissionContact.Address.MapReference.Type","AGAddressCollectionSubmission.SubmissionContact.PhoneNumber.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.EntityContact.Name.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.EntityContact.Address.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.EntityContact.Address.Role","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.EntityContact.Address.MapReference.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.EntityContact.PhoneNumber.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.StudentAddress.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.StudentAddress.Role","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.StudentAddress.MapReference.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent1.ParentName.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent1.ParentAddress.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent1.ParentAddress.Role","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent1.ParentAddress.MapReference.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent2.ParentName.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent2.ParentAddress.Type","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent2.ParentAddress.Role","AGAddressCollectionSubmission.AddressCollectionReportingList.AddressCollectionReporting.AddressCollectionStudentList.AddressCollectionStudent.Parent2.ParentAddress.MapReference.Type"];
attrpaths["AGStatusReport"] = ["AGStatusReport.RefId"];
...
attrpaths["FinancialQuestionnaireSubmission"] = ["FinancialQuestionnaireSubmission.RefId","FinancialQuestionnaireSubmission.SubmissionContact.Name.Type","FinancialQuestionnaireSubmission.SubmissionContact.Address.Type","FinancialQuestionnaireSubmission.SubmissionContact.Address.Role","FinancialQuestionnaireSubmission.SubmissionContact.Address.MapReference.Type","FinancialQuestionnaireSubmission.SubmissionContact.PhoneNumber.Type","FinancialQuestionnaireSubmission.FQReportingList.FQReporting.EntityContact.Name.Type","FinancialQuestionnaireSubmission.FQReportingList.FQReporting.EntityContact.Address.Type","FinancialQuestionnaireSubmission.FQReportingList.FQReporting.EntityContact.Address.Role","FinancialQuestionnaireSubmission.FQReportingList.FQReporting.EntityContact.Address.MapReference.Type","FinancialQuestionnaireSubmission.FQReportingList.FQReporting.EntityContact.PhoneNumber.Type"];
