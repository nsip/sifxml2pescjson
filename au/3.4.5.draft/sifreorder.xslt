...
<xsl:template match="AGAddressCollectionSubmission" mode="object">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
...
<xsl:apply-templates select="AddressCollectionComments" mode="copy" />
...
<xsl:template match="AGStatusReport" mode="object">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="ReportingAuthority" mode="copy" />
<xsl:apply-templates select="ReportingAuthoritySystem" mode="copy" />
...
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="AddressCollectionRefId" mode="copy" />
