...
<xsl:apply-templates select="ActivityEndDate" mode="copy" />
...
<xsl:template match="StudentDataTransferNote" mode="object">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
...
<xsl:apply-templates select="ArrivalSchool" mode="ArrivalSchoolType" />
<xsl:apply-templates select="DepartureSchool" mode="DepartureSchoolType" />
<xsl:apply-templates select="PreviousSchoolList" mode="PreviousSchoolListType" />
<xsl:apply-templates select="NAPLANScoreList" mode="NAPLANScoreWithYearsListType" />
<xsl:apply-templates select="NCCDList" mode="NCCDListType" />
<xsl:apply-templates select="FollowupRequest" mode="copy" />
<xsl:apply-templates select="ChildSubjectToOrders" mode="copy" />
<xsl:apply-templates select="Attendance" mode="copy" />
<xsl:apply-templates select="NationalUniqueStudentIdentifier" mode="copy" />
<xsl:apply-templates select="YearLevel" mode="YearLevelType" />
<xsl:apply-templates select="IndigenousStatus" mode="copy" />
<xsl:apply-templates select="LBOTE" mode="copy" />
<xsl:apply-templates select="VisaStatus" mode="VisaSubClassType" />
<xsl:apply-templates select="OtherNames" mode="OtherNamesType" />
<xsl:apply-templates select="EducationalAssessmentList" mode="EducationalAssessmentListType" />
<xsl:apply-templates select="StudentGradeList" mode="STDNGradeListType" />
<xsl:apply-templates select="LocalCodeList" mode="LocalCodeListType" />
<xsl:apply-templates select="SIF_Metadata" mode="SIF_MetadataType" />
<xsl:apply-templates select="SIF_ExtendedElements" mode="SIF_ExtendedElementsType" />
</xsl:copy>
...
<xsl:apply-templates select="ETag" mode="copy" />
</xsl:copy>
</xsl:template>
...
<xsl:template match="node()|@*" mode="ReportingAuthorityListType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="ReportingAuthority" mode="ReportingAuthorityType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="ReportingAuthorityType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="Name" mode="copy" />
<xsl:apply-templates select="System" mode="copy" />
...
<xsl:template match="node()|@*" mode="SignatoryType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="Name" mode="copy" />
<xsl:apply-templates select="Role" mode="copy" />
<xsl:apply-templates select="Organisation" mode="copy" />
<xsl:apply-templates select="Signature" mode="URIOrBinaryType" />
<xsl:apply-templates select="SignatureImageType" mode="copy" />
<xsl:apply-templates select="Date" mode="copy" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="ArrivalSchoolType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="ACARAId" mode="copy" />
<xsl:apply-templates select="CommonwealthId" mode="copy" />
...
<xsl:template match="node()|@*" mode="DepartureSchoolType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="ACARAId" mode="copy" />
<xsl:apply-templates select="CommonwealthId" mode="copy" />
...
<xsl:template match="node()|@*" mode="PreviousSchoolListType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="PreviousSchool" mode="PreviousSchoolType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="PreviousSchoolType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="ACARAId" mode="copy" />
<xsl:apply-templates select="CommonwealthId" mode="copy" />
...
<xsl:template match="node()|@*" mode="NAPLANScoreListType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="NAPLANScore" mode="NAPLANScoreType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="NAPLANScoreType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="Domain" mode="copy" />
<xsl:apply-templates select="ParticipationCode" mode="copy" />
...
<xsl:template match="node()|@*" mode="NAPLANScoreWithYearsListType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="NAPLANScore" mode="NAPLANScoreWithYearsType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="NAPLANScoreWithYearsType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="Domain" mode="copy" />
<xsl:apply-templates select="ParticipationCode" mode="copy" />
...
<xsl:template match="node()|@*" mode="NCCDListType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="NCCD" mode="NCCDType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="NCCDType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
...
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="EducationalAssessment" mode="EducationalAssessmentType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="EducationalAssessmentType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="Name" mode="copy" />
<xsl:apply-templates select="Content" mode="copy" />
...
<xsl:template match="node()|@*" mode="STDNGradeListType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="StudentGrade" mode="STDNGradeType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="STDNGradeType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="Subject" mode="copy" />
<xsl:apply-templates select="LearningArea" mode="ACStrandSubjectAreaType" />
<xsl:apply-templates select="Grade" mode="GradeType" />
</xsl:copy>
</xsl:template>
<xsl:template match="node()|@*" mode="FTEType">
<xsl:copy>
    <xsl:apply-templates select="@*" mode="copy" />
<xsl:apply-templates select="node()" mode="copy" />
</xsl:copy>
